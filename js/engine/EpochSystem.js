...
export class EpochSystem {
  ...
  #upgradeSystem;
  /** @type {import('./MilestoneSystem.js?v=b7f68d6').MilestoneSystem} */
  #milestoneSystem;
  /** @type {import('./StarManager.js?v=b7f68d6').StarManager} */
  #starManager;
  ...
  /**
   * @param {import('../core/EventBus.js?v=b7f68d6').EventBus} EventBus
   * @param {import('./ResourceManager.js?v=b7f68d6').ResourceManager} resourceManager
   * @param {import('./UpgradeSystem.js?v=b7f68d6').UpgradeSystem} upgradeSystem
   * @param {import('./MilestoneSystem.js?v=b7f68d6').MilestoneSystem} milestoneSystem
   * @param {import('./StarManager.js?v=b7f68d6').StarManager} starManager
      ...
      try {
        if (epochId === 'epoch1') {
          const [dataModule, canvasModule] = await Promise.all([
            import('../data/epoch1.js?v=b7f68d6'),
            import('../data/epoch1-canvas.js?v=b7f68d6'),
          ]);
