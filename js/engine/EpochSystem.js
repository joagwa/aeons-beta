...
export class EpochSystem {
  ...
  #upgradeSystem;
  /** @type {import('./MilestoneSystem.js?v=8b3ecad').MilestoneSystem} */
  #milestoneSystem;
  /** @type {import('./StarManager.js?v=8b3ecad').StarManager} */
  #starManager;
  ...
  /**
   * @param {import('../core/EventBus.js?v=8b3ecad').EventBus} EventBus
   * @param {import('./ResourceManager.js?v=8b3ecad').ResourceManager} resourceManager
   * @param {import('./UpgradeSystem.js?v=8b3ecad').UpgradeSystem} upgradeSystem
   * @param {import('./MilestoneSystem.js?v=8b3ecad').MilestoneSystem} milestoneSystem
   * @param {import('./StarManager.js?v=8b3ecad').StarManager} starManager
      ...
      try {
        if (epochId === 'epoch1') {
          const [dataModule, canvasModule] = await Promise.all([
            import('../data/epoch1.js?v=8b3ecad'),
            import('../data/epoch1-canvas.js?v=8b3ecad'),
          ]);
