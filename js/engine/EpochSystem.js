...
export class EpochSystem {
  ...
  #upgradeSystem;
  /** @type {import('./MilestoneSystem.js?v=567d234').MilestoneSystem} */
  #milestoneSystem;
  /** @type {import('./StarManager.js?v=567d234').StarManager} */
  #starManager;
   ...
   * @param {import('./ResourceManager.js?v=567d234').ResourceManager} resourceManager
   * @param {import('./UpgradeSystem.js?v=567d234').UpgradeSystem} upgradeSystem
   * @param {import('./MilestoneSystem.js?v=567d234').MilestoneSystem} milestoneSystem
   * @param {import('./StarManager.js?v=567d234').StarManager} starManager
      ...
      try {
        if (epochId === 'epoch1') {
          const [dataModule, canvasModule] = await Promise.all([
            import('../data/epoch1.js?v=567d234'),
            import('../data/epoch1-canvas.js?v=567d234'),
          ]);
