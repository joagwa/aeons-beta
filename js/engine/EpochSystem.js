...
export class EpochSystem {
  ...
  #upgradeSystem;
  /** @type {import('./MilestoneSystem.js?v=f0dd23a').MilestoneSystem} */
  #milestoneSystem;
  /** @type {import('./StarManager.js?v=f0dd23a').StarManager} */
  #starManager;
  ...
  /**
   * @param {import('../core/EventBus.js?v=f0dd23a').EventBus} EventBus
   * @param {import('./ResourceManager.js?v=f0dd23a').ResourceManager} resourceManager
   * @param {import('./UpgradeSystem.js?v=f0dd23a').UpgradeSystem} upgradeSystem
   * @param {import('./MilestoneSystem.js?v=f0dd23a').MilestoneSystem} milestoneSystem
   * @param {import('./StarManager.js?v=f0dd23a').StarManager} starManager
      ...
      try {
        if (epochId === 'epoch1') {
          const [dataModule, canvasModule] = await Promise.all([
            import('../data/epoch1.js?v=f0dd23a'),
            import('../data/epoch1-canvas.js?v=f0dd23a'),
          ]);
