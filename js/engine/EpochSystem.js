...
export class EpochSystem {
  ...
  #upgradeSystem;
  /** @type {import('./MilestoneSystem.js?v=d57fed4').MilestoneSystem} */
  #milestoneSystem;
  /** @type {import('./StarManager.js?v=d57fed4').StarManager} */
  #starManager;
  ...
  /**
   * @param {import('../core/EventBus.js?v=d57fed4').EventBus} EventBus
   * @param {import('./ResourceManager.js?v=d57fed4').ResourceManager} resourceManager
   * @param {import('./UpgradeSystem.js?v=d57fed4').UpgradeSystem} upgradeSystem
   * @param {import('./MilestoneSystem.js?v=d57fed4').MilestoneSystem} milestoneSystem
   * @param {import('./StarManager.js?v=d57fed4').StarManager} starManager
      ...
      try {
        if (epochId === 'epoch1') {
          const [dataModule, canvasModule] = await Promise.all([
            import('../data/epoch1.js?v=d57fed4'),
            import('../data/epoch1-canvas.js?v=d57fed4'),
          ]);
