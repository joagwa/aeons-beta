...
export class EpochSystem {
  ...
  #upgradeSystem;
  /** @type {import('./MilestoneSystem.js?v=2243215').MilestoneSystem} */
  #milestoneSystem;
  /** @type {import('./StarManager.js?v=2243215').StarManager} */
  #starManager;
   ...
   * @param {import('./ResourceManager.js?v=2243215').ResourceManager} resourceManager
   * @param {import('./UpgradeSystem.js?v=2243215').UpgradeSystem} upgradeSystem
   * @param {import('./MilestoneSystem.js?v=2243215').MilestoneSystem} milestoneSystem
   * @param {import('./StarManager.js?v=2243215').StarManager} starManager
      ...
      try {
        if (epochId === 'epoch1') {
          const [dataModule, canvasModule] = await Promise.all([
            import('../data/epoch1.js?v=2243215'),
            import('../data/epoch1-canvas.js?v=2243215'),
          ]);
