...
export class EpochSystem {
  ...
  #resourceManager;
  /** @type {import('./UpgradeSystem.js?v=62753f8').UpgradeSystem} */
  #upgradeSystem;
  /** @type {import('./MilestoneSystem.js?v=62753f8').MilestoneSystem} */
  #milestoneSystem;
  /** @type {import('./StarManager.js?v=62753f8').StarManager} */
  #starManager;
  ...
  /**
   * @param {import('../core/EventBus.js?v=62753f8').EventBus} EventBus
   * @param {import('./ResourceManager.js?v=62753f8').ResourceManager} resourceManager
   * @param {import('./UpgradeSystem.js?v=62753f8').UpgradeSystem} upgradeSystem
   * @param {import('./MilestoneSystem.js?v=62753f8').MilestoneSystem} milestoneSystem
   * @param {import('./StarManager.js?v=62753f8').StarManager} starManager
      ...
      try {
        if (epochId === 'epoch1') {
          const [dataModule, canvasModule] = await Promise.all([
            import('../data/epoch1.js?v=62753f8'),
            import('../data/epoch1-canvas.js?v=62753f8'),
          ]);
