...
export class EpochSystem {
  /** @type {import('../core/EventBus.js?v=a72fd91').EventBus} */
  #eventBus;
  /** @type {import('./ResourceManager.js?v=a72fd91').ResourceManager} */
  #resourceManager;
  /** @type {import('./UpgradeSystem.js?v=a72fd91').UpgradeSystem} */
  #upgradeSystem;
  /** @type {import('./MilestoneSystem.js?v=a72fd91').MilestoneSystem} */
  #milestoneSystem;
  /** @type {import('./StarManager.js?v=a72fd91').StarManager} */
  #starManager;
  ...
  /**
   * @param {import('../core/EventBus.js?v=a72fd91').EventBus} EventBus
   * @param {import('./ResourceManager.js?v=a72fd91').ResourceManager} resourceManager
   * @param {import('./UpgradeSystem.js?v=a72fd91').UpgradeSystem} upgradeSystem
   * @param {import('./MilestoneSystem.js?v=a72fd91').MilestoneSystem} milestoneSystem
   * @param {import('./StarManager.js?v=a72fd91').StarManager} starManager
      ...
      try {
        if (epochId === 'epoch1') {
          const [dataModule, canvasModule] = await Promise.all([
            import('../data/epoch1.js?v=a72fd91'),
            import('../data/epoch1-canvas.js?v=a72fd91'),
          ]);
