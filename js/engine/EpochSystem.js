...
export class EpochSystem {
  ...
  #resourceManager;
  /** @type {import('./UpgradeSystem.js?v=6c1e06a').UpgradeSystem} */
  #upgradeSystem;
  /** @type {import('./MilestoneSystem.js?v=6c1e06a').MilestoneSystem} */
  #milestoneSystem;
  /** @type {import('./StarManager.js?v=6c1e06a').StarManager} */
  #starManager;
  ...
  /**
   * @param {import('../core/EventBus.js?v=6c1e06a').EventBus} EventBus
   * @param {import('./ResourceManager.js?v=6c1e06a').ResourceManager} resourceManager
   * @param {import('./UpgradeSystem.js?v=6c1e06a').UpgradeSystem} upgradeSystem
   * @param {import('./MilestoneSystem.js?v=6c1e06a').MilestoneSystem} milestoneSystem
   * @param {import('./StarManager.js?v=6c1e06a').StarManager} starManager
      ...
      try {
        if (epochId === 'epoch1') {
          const [dataModule, canvasModule] = await Promise.all([
            import('../data/epoch1.js?v=6c1e06a'),
            import('../data/epoch1-canvas.js?v=6c1e06a'),
          ]);
