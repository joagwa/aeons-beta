...
export class EpochSystem {
  ...
  /**
   * @param {import('../core/EventBus.js?v=152da54').EventBus} EventBus
   * @param {import('./ResourceManager.js?v=152da54').ResourceManager} resourceManager
   * @param {import('./UpgradeSystem.js?v=152da54').UpgradeSystem} upgradeSystem
   * @param {import('./MilestoneSystem.js?v=152da54').MilestoneSystem} milestoneSystem
   * @param {import('./StarManager.js?v=152da54').StarManager} starManager
      ...
      try {
        if (epochId === 'epoch1') {
          const [dataModule, canvasModule] = await Promise.all([
            import('../data/epoch1.js?v=152da54'),
            import('../data/epoch1-canvas.js?v=152da54'),
          ]);
