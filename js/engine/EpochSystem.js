...
export class EpochSystem {
  /** @type {import('../core/EventBus.js?v=c2ea3a4').EventBus} */
  #eventBus;
  /** @type {import('./ResourceManager.js?v=c2ea3a4').ResourceManager} */
  #resourceManager;
  /** @type {import('./UpgradeSystem.js?v=c2ea3a4').UpgradeSystem} */
  #upgradeSystem;
  /** @type {import('./MilestoneSystem.js?v=c2ea3a4').MilestoneSystem} */
  #milestoneSystem;
  /** @type {import('./StarManager.js?v=c2ea3a4').StarManager} */
  #starManager;
  ...
  /**
   * @param {import('../core/EventBus.js?v=c2ea3a4').EventBus} EventBus
   * @param {import('./ResourceManager.js?v=c2ea3a4').ResourceManager} resourceManager
   * @param {import('./UpgradeSystem.js?v=c2ea3a4').UpgradeSystem} upgradeSystem
   * @param {import('./MilestoneSystem.js?v=c2ea3a4').MilestoneSystem} milestoneSystem
   * @param {import('./StarManager.js?v=c2ea3a4').StarManager} starManager
      ...
      try {
        if (epochId === 'epoch1') {
          const [dataModule, canvasModule] = await Promise.all([
            import('../data/epoch1.js?v=c2ea3a4'),
            import('../data/epoch1-canvas.js?v=c2ea3a4'),
          ]);
