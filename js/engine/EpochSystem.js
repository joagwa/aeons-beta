...
export class EpochSystem {
  ...
  #resourceManager;
  /** @type {import('./UpgradeSystem.js?v=3860daf').UpgradeSystem} */
  #upgradeSystem;
  /** @type {import('./MilestoneSystem.js?v=3860daf').MilestoneSystem} */
  #milestoneSystem;
  /** @type {import('./StarManager.js?v=3860daf').StarManager} */
  #starManager;
   ...
   * @param {import('./UpgradeSystem.js?v=3860daf').UpgradeSystem} upgradeSystem
   * @param {import('./MilestoneSystem.js?v=3860daf').MilestoneSystem} milestoneSystem
   * @param {import('./StarManager.js?v=3860daf').StarManager} starManager
      ...
      try {
        if (epochId === 'epoch1') {
          const [dataModule, canvasModule] = await Promise.all([
            import('../data/epoch1.js?v=3860daf'),
            import('../data/epoch1-canvas.js?v=3860daf'),
          ]);
