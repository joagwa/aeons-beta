...
export class EpochSystem {
  ...
  #eventBus;
  /** @type {import('./ResourceManager.js?v=c0bb3c7').ResourceManager} */
  #resourceManager;
  /** @type {import('./UpgradeSystem.js?v=c0bb3c7').UpgradeSystem} */
  #upgradeSystem;
  /** @type {import('./MilestoneSystem.js?v=c0bb3c7').MilestoneSystem} */
  #milestoneSystem;
  /** @type {import('./StarManager.js?v=c0bb3c7').StarManager} */
  #starManager;
   ...
   * @param {import('./ResourceManager.js?v=c0bb3c7').ResourceManager} resourceManager
   * @param {import('./UpgradeSystem.js?v=c0bb3c7').UpgradeSystem} upgradeSystem
   * @param {import('./MilestoneSystem.js?v=c0bb3c7').MilestoneSystem} milestoneSystem
   * @param {import('./StarManager.js?v=c0bb3c7').StarManager} starManager
      ...
      try {
        if (epochId === 'epoch1') {
          const [dataModule, canvasModule] = await Promise.all([
            import('../data/epoch1.js?v=c0bb3c7'),
            import('../data/epoch1-canvas.js?v=c0bb3c7'),
          ]);
