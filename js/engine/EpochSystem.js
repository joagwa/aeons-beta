...
export class EpochSystem {
  ...
  #resourceManager;
  /** @type {import('./UpgradeSystem.js?v=64ea755').UpgradeSystem} */
  #upgradeSystem;
  /** @type {import('./MilestoneSystem.js?v=64ea755').MilestoneSystem} */
  #milestoneSystem;
  /** @type {import('./StarManager.js?v=64ea755').StarManager} */
  #starManager;
   ...
   * @param {import('./UpgradeSystem.js?v=64ea755').UpgradeSystem} upgradeSystem
   * @param {import('./MilestoneSystem.js?v=64ea755').MilestoneSystem} milestoneSystem
   * @param {import('./StarManager.js?v=64ea755').StarManager} starManager
      ...
      try {
        if (epochId === 'epoch1') {
          const [dataModule, canvasModule] = await Promise.all([
            import('../data/epoch1.js?v=64ea755'),
            import('../data/epoch1-canvas.js?v=64ea755'),
          ]);
