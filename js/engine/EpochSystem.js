...
export class EpochSystem {
  ...
  #resourceManager;
  /** @type {import('./UpgradeSystem.js?v=55d199b').UpgradeSystem} */
  #upgradeSystem;
  /** @type {import('./MilestoneSystem.js?v=55d199b').MilestoneSystem} */
  #milestoneSystem;
  /** @type {import('./StarManager.js?v=55d199b').StarManager} */
  #starManager;
  ...
  /**
   * @param {import('../core/EventBus.js?v=55d199b').EventBus} EventBus
   * @param {import('./ResourceManager.js?v=55d199b').ResourceManager} resourceManager
   * @param {import('./UpgradeSystem.js?v=55d199b').UpgradeSystem} upgradeSystem
   * @param {import('./MilestoneSystem.js?v=55d199b').MilestoneSystem} milestoneSystem
   * @param {import('./StarManager.js?v=55d199b').StarManager} starManager
      ...
      try {
        if (epochId === 'epoch1') {
          const [dataModule, canvasModule] = await Promise.all([
            import('../data/epoch1.js?v=55d199b'),
            import('../data/epoch1-canvas.js?v=55d199b'),
          ]);
