...
export class EpochSystem {
  ...
  #resourceManager;
  /** @type {import('./UpgradeSystem.js?v=b34c567').UpgradeSystem} */
  #upgradeSystem;
  /** @type {import('./MilestoneSystem.js?v=b34c567').MilestoneSystem} */
  #milestoneSystem;
  /** @type {import('./StarManager.js?v=b34c567').StarManager} */
  #starManager;
   ...
   * @param {import('./ResourceManager.js?v=b34c567').ResourceManager} resourceManager
   * @param {import('./UpgradeSystem.js?v=b34c567').UpgradeSystem} upgradeSystem
   * @param {import('./MilestoneSystem.js?v=b34c567').MilestoneSystem} milestoneSystem
   * @param {import('./StarManager.js?v=b34c567').StarManager} starManager
      ...
      try {
        if (epochId === 'epoch1') {
          const [dataModule, canvasModule] = await Promise.all([
            import('../data/epoch1.js?v=b34c567'),
            import('../data/epoch1-canvas.js?v=b34c567'),
          ]);
