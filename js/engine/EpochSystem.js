...
export class EpochSystem {
  /** @type {import('../core/EventBus.js?v=cce5ba0').EventBus} */
  #eventBus;
  /** @type {import('./ResourceManager.js?v=cce5ba0').ResourceManager} */
  #resourceManager;
  /** @type {import('./UpgradeSystem.js?v=cce5ba0').UpgradeSystem} */
  #upgradeSystem;
  /** @type {import('./MilestoneSystem.js?v=cce5ba0').MilestoneSystem} */
  #milestoneSystem;
  /** @type {import('./StarManager.js?v=cce5ba0').StarManager} */
  #starManager;
  ...
  /**
   * @param {import('../core/EventBus.js?v=cce5ba0').EventBus} EventBus
   * @param {import('./ResourceManager.js?v=cce5ba0').ResourceManager} resourceManager
   * @param {import('./UpgradeSystem.js?v=cce5ba0').UpgradeSystem} upgradeSystem
   * @param {import('./MilestoneSystem.js?v=cce5ba0').MilestoneSystem} milestoneSystem
   * @param {import('./StarManager.js?v=cce5ba0').StarManager} starManager
      ...
      try {
        if (epochId === 'epoch1') {
          const [dataModule, canvasModule] = await Promise.all([
            import('../data/epoch1.js?v=cce5ba0'),
            import('../data/epoch1-canvas.js?v=cce5ba0'),
          ]);
