...
import { SpriteManager } from './SpriteManager.js?v=a5f8f0f';
import { Camera } from './Camera.js?v=a5f8f0f';
import { ParticleSystem } from './ParticleSystem.js?v=a5f8f0f';
import { RegionManager } from './RegionManager.js?v=a5f8f0f';
import { FloatingNumbers } from './FloatingNumbers.js?v=a5f8f0f';
import { OrbitalEnergyDisplay } from './OrbitalEnergyDisplay.js?v=a5f8f0f';
import { EpochCollapseAnimation } from './EpochCollapseAnimation.js?v=a5f8f0f';
...
export class CanvasRenderer {
  constructor(EventBus) {
    ...
    /** @type {import('../engine/DarkMatterSystem.js?v=a5f8f0f').DarkMatterSystem|null} */
   ...
   * @param {import('../engine/DarkMatterSystem.js?v=a5f8f0f').DarkMatterSystem} sys
   */
