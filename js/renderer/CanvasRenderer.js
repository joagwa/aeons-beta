...
import { SpriteManager } from './SpriteManager.js?v=94ce1d0';
import { Camera } from './Camera.js?v=94ce1d0';
import { ParticleSystem } from './ParticleSystem.js?v=94ce1d0';
import { RegionManager } from './RegionManager.js?v=94ce1d0';
import { FloatingNumbers } from './FloatingNumbers.js?v=94ce1d0';
import { OrbitalEnergyDisplay } from './OrbitalEnergyDisplay.js?v=94ce1d0';
import { EpochCollapseAnimation } from './EpochCollapseAnimation.js?v=94ce1d0';
...
export class CanvasRenderer {
  constructor(EventBus) {
    ...
    /** @type {import('../engine/DarkMatterSystem.js?v=94ce1d0').DarkMatterSystem|null} */
   ...
   * @param {import('../engine/DarkMatterSystem.js?v=94ce1d0').DarkMatterSystem} sys
   */
