...
import { SpriteManager } from './SpriteManager.js?v=55d199b';
import { Camera } from './Camera.js?v=55d199b';
import { ParticleSystem } from './ParticleSystem.js?v=55d199b';
import { RegionManager } from './RegionManager.js?v=55d199b';
import { FloatingNumbers } from './FloatingNumbers.js?v=55d199b';
import { OrbitalEnergyDisplay } from './OrbitalEnergyDisplay.js?v=55d199b';
import { EpochCollapseAnimation } from './EpochCollapseAnimation.js?v=55d199b';
...
export class CanvasRenderer {
  constructor(EventBus) {
    ...
    /** @type {import('../engine/DarkMatterSystem.js?v=55d199b').DarkMatterSystem|null} */
   ...
   * @param {import('../engine/DarkMatterSystem.js?v=55d199b').DarkMatterSystem} sys
   */
