...
import { SpriteManager } from './SpriteManager.js?v=b7f68d6';
import { Camera } from './Camera.js?v=b7f68d6';
import { ParticleSystem } from './ParticleSystem.js?v=b7f68d6';
import { RegionManager } from './RegionManager.js?v=b7f68d6';
import { FloatingNumbers } from './FloatingNumbers.js?v=b7f68d6';
import { OrbitalEnergyDisplay } from './OrbitalEnergyDisplay.js?v=b7f68d6';
import { EpochCollapseAnimation } from './EpochCollapseAnimation.js?v=b7f68d6';
...
export class CanvasRenderer {
  constructor(EventBus) {
    ...
    /** @type {import('../engine/DarkMatterSystem.js?v=b7f68d6').DarkMatterSystem|null} */
   ...
   * @param {import('../engine/DarkMatterSystem.js?v=b7f68d6').DarkMatterSystem} sys
   */
